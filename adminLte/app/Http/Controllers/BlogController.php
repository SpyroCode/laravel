...
class BlogController extends Controller
{
    ...
    //el metodo para mostrar tpdos los resgistros
    ...
    //metodo para aculizar un solo resgistro
    ...
    public function update($id, Request $request){
    	...
    	if(!empty($datos)){
    		...
    		$validar = \Validator::make($datos, [
    			...
    			"keyword" => 'required|regex:/^[,\\0-9a-zA-ZñÑáéíóúÁÉÍÓÚ ]+$/i',
    		...
    		if($validar->fails()){
    			...
    			$actualizar = array("dominio"=> $datos["dominio"],
    				                ...
    				                "palabras_claves" => json_encode(explode(",", $datos["keyword"])),
